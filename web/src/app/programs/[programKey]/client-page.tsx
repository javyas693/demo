...
import { simulateScenario, program as getProgram, postPlanPropose, postPlanCommit, ProgramWorkspaceResponse, TradePlan, simulateConcentratedPosition, SimulationResult, patchProfile } from "@/lib/api"
                    ...
                    <div className="mx-auto max-w-4xl space-y-8">
                        ...
                        <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full mt-6">
                            ...
                            <TabsContent value="current_state" className="pt-8 space-y-6 outline-none">
                                ...
                                <Card className="border-indigo-100 dark:border-indigo-900/30 overflow-hidden relative shadow-sm mt-8">
                                    <CardHeader>
